...
class EKF:
    ...
    def predict(self, raw_drive_meas):
        F = self.state_transition(raw_drive_meas) # A in the lecture slides
    ...
    def update(self, measurements):
        ...
        z_hat = z_hat.reshape((-1,1),order="F") # h(mu_bar) in the lecture slides 
        H = self.robot.derivative_measure(self.markers, idx_list) # C in the lecture slides 
        ...
        self.P = (np.identity((K.shape[0]))-K @ H) @ self.P
